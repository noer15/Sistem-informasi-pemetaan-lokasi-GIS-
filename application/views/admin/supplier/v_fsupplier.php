                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
                                <form action="<?php echo site_url('admin/Supplier/aksi_tambah'); ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea required class="form-control" name="alamat_supplier"></textarea>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label">Nomor Telepon Supplier</label>
                                        <input required type="text" class="form-control" name="telp_supplier" />
                                    </div>
                                    <div class="form-group">
